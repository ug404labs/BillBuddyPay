            ...
            <div className="min-h-screen bg-gray-100 flex">
                ...
                <div className="hidden lg:flex w-1/2 bg-green-600 text-white p-12 flex-col justify-between">
                    <div>
                        ...
                        <p className="text-xl mb-8">Your Financial Ecosystem on the Blockchain</p>
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center p-12">
                    <div className="max-w-md w-full space-y-8">
                        ...
                        <div className="text-sm text-center">
                            <a href="#" className="font-medium text-green-600 hover:text-green-500 flex items-center justify-center">
